...
% ----------------------------------------------------------
%
% the following packages and their dependencies are required for this template
% -texlive-base
% -texlive-binaires
% -texlive-latex-base
% -texlive-latex-extra
...
% -texlive-pictures
% -texlive-fonts-extra  |  ootional, for use of different fonts such as Roboto
%
%
\documentclass[rnd]{proposal_style_template} % alternatively use option 'thesis' instead of 'rnd'

% logos for title page
\centerlogo{}
\rightlogo{images/b-it.pdf}
\leftlogo{images/Logo-HBRS-cyan.png}

\title{Project Proposal Title}
\subtitle{Subtitle}
\author{FirstName LastName}
\institution{Institution\\Street Address 1\\City}
\date{Month 20XX}
